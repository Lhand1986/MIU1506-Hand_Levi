...
//Rare exceptions to indicate a bug in the _k1506_aboutme_hand_levi code (Eg, function that a subclass should have implemented)
...
/**
 The base class for k1506_AboutMe_Hand_Levi proxies.
 */
