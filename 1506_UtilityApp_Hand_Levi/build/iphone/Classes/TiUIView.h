...
/**
 Base class for all k1506_UtilityApp_Hand_Levi views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the k1506_UtilityApp_Hand_Levi view hierarchy (such as wrapped iOS UIViews) was touched.
