...
// in simulator we redefine to format for k1506_AboutMe_Hand_Levi Developer console
...
{\
	NSString * exceptionName = [@"org.k1506_aboutme_hand_levi." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.k1506_aboutme_hand_levi";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIk1506_AboutMe_Hand_LeviNativeItemNone = -1, 
	UIk1506_AboutMe_Hand_LeviNativeItemSpinner = -2,
	UIk1506_AboutMe_Hand_LeviNativeItemProgressBar = -3,
	
	UIk1506_AboutMe_Hand_LeviNativeItemSlider = -4,
	UIk1506_AboutMe_Hand_LeviNativeItemSwitch = -5,
	UIk1506_AboutMe_Hand_LeviNativeItemMultiButton = -6,
	UIk1506_AboutMe_Hand_LeviNativeItemSegmented = -7,
	
	UIk1506_AboutMe_Hand_LeviNativeItemTextView = -8,
	UIk1506_AboutMe_Hand_LeviNativeItemTextField = -9,
	UIk1506_AboutMe_Hand_LeviNativeItemSearchBar = -10,
	
	UIk1506_AboutMe_Hand_LeviNativeItemPicker = -11,
	UIk1506_AboutMe_Hand_LeviNativeItemDatePicker = -12,
	
	UIk1506_AboutMe_Hand_LeviNativeItemInfoLight = -13,
	UIk1506_AboutMe_Hand_LeviNativeItemInfoDark = -14,
	
	UIk1506_AboutMe_Hand_LeviNativeItemDisclosure = -15,
	
	UIk1506_AboutMe_Hand_LeviNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all k1506_AboutMe_Hand_Levi instances of
