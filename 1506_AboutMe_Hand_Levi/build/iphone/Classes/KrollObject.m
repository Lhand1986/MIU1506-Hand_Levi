...
//@interface k1506_AboutMe_Hand_LeviObject : NSObject
//@end

@interface k1506_AboutMe_Hand_LeviObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[k1506_AboutMe_Hand_LeviObject class]])
		{
			for (NSString *key in [[(k1506_AboutMe_Hand_LeviObject*)o modules] allKeys])
			{
