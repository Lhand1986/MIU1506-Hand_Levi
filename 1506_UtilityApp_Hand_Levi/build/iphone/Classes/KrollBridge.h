...
@interface k1506_UtilityApp_Hand_LeviObject : KrollCoverageObject {
#else
@interface k1506_UtilityApp_Hand_LeviObject : KrollObject {
#endif
@private
...
extern NSString * k1506_UtilityApp_Hand_Levi$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	k1506_UtilityApp_Hand_LeviObject *_k1506_utilityapp_hand_levi;
    KrollObject* console;
	BOOL shutdown;
