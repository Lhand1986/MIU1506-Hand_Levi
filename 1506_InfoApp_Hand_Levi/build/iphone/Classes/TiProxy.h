...
//Rare exceptions to indicate a bug in the _k1506_infoapp_hand_levi code (Eg, function that a subclass should have implemented)
...
/**
 The base class for k1506_InfoApp_Hand_Levi proxies.
 */
